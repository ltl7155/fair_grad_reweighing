...
#         print(tp_target_11)
    ...
    return ap, gap_logit, EO_05

def evaluate_eo_eop(model, X_test, y_test, A_test):
...
#         print(tp_target_11)
        ...
        if tp_target_01 < tp_target_11:
            EOP_05 = tp_target_01 / tp_target_11
        else:
            EOP_05 = tp_target_11 / tp_target_01
    except:
        print("Warning:" + "*"*100)
        tp_target_00 = tp_target_01 = tp_target_10 = tp_target_11 = 0
    ...
    print(f"ap:{ap}, gap_logit:{gap_logit}, EO_05:{EO_05}, EOP_05:{EOP_05}")

    return ap, gap_logit, EO_05, EOP_05
